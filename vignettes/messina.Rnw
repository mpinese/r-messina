...
tumour.
<< >>=
fit.apColon = messina(x, y == "tumor", min_sens = 0.95, min_spec = 0.85, seed = 1234, progress = FALSE)
@
...
normal samples, with a very wide margin of approximately 7 units, or about 120-fold.
