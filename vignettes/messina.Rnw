...
<<surv-fit>>=
fit.surv.tau = messinaSurv(kirc.exprs, kirc.surv, objective = messinaSurvObj.Tau(0.6), parallel = FALSE, silent = TRUE)
fit.surv.coxcoef = messinaSurv(kirc.exprs, kirc.surv, objective = messinaSurvObj.CoxCoef(log(2)), parallel = FALSE, silent = TRUE)
